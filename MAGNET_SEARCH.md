...
| 版本 | 变更 |
|------|------|
| v2.0.1 | 修复 MovieActivity 空指针：`JAViewer.SERVICE` 改为 `getService()` 懒初始化，增加 null 安全处理 |
| v2.0.1 | DownloadActivity 新增 btsow Tab (MagnetSearchFragment)、番号点击统一跳转 DownloadActivity、移除下载计数提示弹窗、移除 MagnetSearchActivity 死代码 |
